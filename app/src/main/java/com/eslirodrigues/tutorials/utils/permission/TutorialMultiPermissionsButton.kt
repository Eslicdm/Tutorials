...
@Composable
fun TutorialMultiPermissionsButton(
    onClick: () -> Unit,
    text: String
) {
    ...
    if (showPermissionDialog) TutorialMultiPermissionDialog(multiPermissionsState)
...
@OptIn(ExperimentalPermissionsApi::class)
@Composable
fun TutorialMultiPermissionDialog(permissionsState: MultiplePermissionsState) {
