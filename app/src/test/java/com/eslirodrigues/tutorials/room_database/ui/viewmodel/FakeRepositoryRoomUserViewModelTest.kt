...
import com.eslirodrigues.tutorials.room_database.data.repository.FakeRoomUserRepository
...
class FakeRepositoryRoomUserViewModelTest {
    ...
    fun setUp() {
        ...
        roomUserViewModel = RoomUserViewModel(fakeRoomUserRepository)
    }
